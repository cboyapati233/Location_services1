...
class _AppState extends State<App>{
  ...
  void Function(Timer timer) timer;
  ...
  startTimeout()async {
    void Function(Timer timer) timer;
    return new Timer.periodic(timeout,_currentLocation(timer));
  }
  ...
  _currentLocation([void Function(Timer timer) timer]) async {
    ...
    databaseReference.collection('Location').document('1').setData({
      'Location and Time : ': _address
    });
    ...
    final text = _address;
    final date1=_date;
    await new File('${directory.path}/location_file1.txt').writeAsString(text);
